			...
			step(
				() => {
					if (
						...
						let slotable =
							isSlotable(targetImpl) && targetImpl._assignedSlot
								? targetImpl
								: null;
						...
						while (parent !== null) {
							...
							const shouldAddParentWithoutRetargeting =
								...
								(isNode(parent) &&
									isShadowInclusiveAncestor(parent, originalTarget)) || // Parent is ancestor of original target
...
const _invokeEventListeners = cadence(
	(
		step,
		struct,
		eventImpl,
...
const _innerInvokeEventListeners = cadence(
	(
		step,
		eventImpl,
		listeners,
