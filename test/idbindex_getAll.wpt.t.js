    ...
    await harness(async () => {
          ...
          indexeddb_test(
            (t, connection, tx) => {
              ...
              alphabet.forEach((letter) => {
                ...
                if (letter === 'z')
                  {attrs.push('last');}
                store.put({attribs: attrs, ch: letter}, letter);
              });
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  ...
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), ['c']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), ['C']);
                  t.done();
              });
            }, 'Single item get');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), alphabet);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), ALPHABET);
                  t.done();
              });
            }, 'Get all keys');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), [...'abcdefghij']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), [...'ABCDEFGHIJ']);
                  t.done();
              });
            }, 'maxCount=10');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), [...'ghijklm']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), [...'GHIJKLM']);
                  t.done();
              });
            }, 'Get bound range');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), [...'ghi']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), [...'GHI']);
                  t.done();
              });
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), [...'ghij']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), [...'GHIJ']);
                  t.done();
              });
            }, 'Get upper excluded');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), [...'hijk']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.upper; }), [...'HIJK']);
                  t.done();
              });
            }, 'Get lower excluded');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), [...'abcdefghijklm']);
                  assert_true(data.every(function onsuccess(_e) { return e.half === 'first'; }));
                  t.done();
              });
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_class_string(data, 'Array', 'result should be an array');
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), ['a', 'e', 'i', 'o', 'u']);
                  assert_array_equals(data[0].attribs, ['vowel', 'first']);
                  assert_true(data.every(function onsuccess(_e) { return e.attribs[0] === 'vowel'; }));
                  t.done();
              });
