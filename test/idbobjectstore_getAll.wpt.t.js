	...
	await harness(async () => {
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				assert_array_equals(
					evt.target.result,
					alphabet.map(function onsuccess(c) {
						return "value-" + c;
					}),
				);
				t.done();
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				assert_array_equals(
					evt.target.result,
					[..."abcdefghij"].map(function onsuccess(c) {
						return "value-" + c;
					}),
				);
				t.done();
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				assert_array_equals(
					evt.target.result,
					[..."ghijklm"].map(function onsuccess(c) {
						return "value-" + c;
					}),
				);
				t.done();
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				assert_array_equals(
					evt.target.result,
					["g", "h", "i"].map(function onsuccess(c) {
						return "value-" + c;
					}),
				);
				t.done();
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				assert_array_equals(
					evt.target.result,
					["g", "h", "i", "j"].map(function onsuccess(c) {
						return "value-" + c;
					}),
				);
				t.done();
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				assert_array_equals(
					evt.target.result,
					["h", "i", "j", "k"].map(function onsuccess(c) {
						return "value-" + c;
					}),
				);
				t.done();
		...
		getall_test((t, connection) => {
			...
			req.onsuccess = t.step_func(function onsuccess(evt) {
				...
				assert_true(Array.isArray(data));
				assert_array_equals(
					data.map(function onsuccess(_e) {
						return e.ch;
					}),
					["d", "e", "f"],
				);
