require('proof')(17, async okay => {
    ...
    await harness(async () => {
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  assert_array_equals(evt.target.result,
                      alphabet.map(function onsuccess(c) { return 'value-' + c; }));
                  t.done();
              });
            }, 'Get all values');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  assert_array_equals(evt.target.result,
                      [...'abcdefghij'].map(function onsuccess(c) { return 'value-' + c; }));
                  t.done();
              });
            }, 'Test maxCount');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  assert_array_equals(evt.target.result,
                      [...'ghijklm'].map(function onsuccess(c) { return 'value-' + c; }));
                  t.done();
              });
            }, 'Get bound range');
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  assert_array_equals(evt.target.result, ['g', 'h', 'i']
                      .map(function onsuccess(c) { return 'value-' + c; }));
                  t.done();
              });
        ...
        getall_test((t, connection) => {
              ...
              req.onsuccess = t.step_func(function onsuccess(evt) {
                  var data = evt.target.result;
                  assert_true(Array.isArray(data));
                  assert_array_equals(data.map(function onsuccess(_e) { return e.ch; }), ['d', 'e', 'f']);
                  assert_array_equals(data.map(function onsuccess(_e) { return e.id; }), [4, 5, 6]);
                  t.done();
              });
