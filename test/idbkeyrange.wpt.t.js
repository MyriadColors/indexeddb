require('proof')(42, async okay => {
    ...
    await harness(async () => {
        ...
        test( () => {
            assert_throws_dom('DataError', () => { IDBKeyRange.only(); }, 'undefined is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.only(null); }, 'null is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.only({}); }, 'Object is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.only(Symbol()); }, 'Symbol is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.only(true); }, 'boolean is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.only(() => {}); }, 'function is not a valid key');
        ...
        test( () => {
            assert_throws_dom('DataError', () => { IDBKeyRange.lowerBound(); }, 'undefined is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.lowerBound(null); }, 'null is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.lowerBound({}); }, 'Object is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.lowerBound(Symbol()); }, 'Symbol is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.lowerBound(true); }, 'boolean is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.lowerBound(() => {}); }, 'function is not a valid key');
        ...
        test( () => {
            assert_throws_dom('DataError', () => { IDBKeyRange.upperBound(); }, 'undefined is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.upperBound(null); }, 'null is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.upperBound({}); }, 'Object is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.upperBound(Symbol()); }, 'Symbol is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.upperBound(true); }, 'boolean is not a valid key');
            assert_throws_dom('DataError', () => { IDBKeyRange.upperBound(() => {}); }, 'function is not a valid key');
