require("proof")(23, (okay) => {
	...
	okay(
		compare(Uint8Array.of(1).buffer, Uint8Array.of(1).buffer) === 0,
		"binary equal",
	);
	okay(
		compare(Uint8Array.of(0).buffer, Uint8Array.of(1).buffer) < 0,
		"binary less than",
	);
	okay(
		compare(Uint8Array.of(1, 1).buffer, Uint8Array.of(1).buffer) > 0,
		"binary longer than",
	);
